...
pridruzhivanje relevantnih informacija svakoj varijanti na osnovu razlichitih baza
podataka i na osnovu razlichitih alata, na primer na kojoj se poziciji na hromozomu
nalazi varijacija u odnosu na referentni genom, u kom je genu, kakvi su njeni predvidjeni funkcionalni efekti itd. Ulazni podaci su {\Lat .vcf} datoteke u kojima se nalaze informacije o genet{s}kim varijacijama. Izlazni podaci su pridruzhene informacije, zapravo datoteke sa anotacijama.

\textbf{Specifichni cilj rada:}\\
Cilj ovog rada je implementacija dodatka za softver {\Lat Annovar} koji bi omoguc1io prikaz informacija o funkciji i fenotipu gena. Za ulazne datoteke bi se uzeli podaci \textit{Ashkenazi otac-majka-sin} trija iz projekta \zn Lichni genom''.  Iz izlazne datoteke {\Lat Annovar-a} se uzima informacija o genu na kojoj se nalazi odgovarajuc1a varijacija. Kako radimo sa genima, predmet analize su samo egzoni (varijanti ima i u nekodirajuc1im regionima). Pored informacija koje se dobijaju cilj je prikazati i funkciju i fenotip i to na osnovu dve baze znanja tj. ontologije - {\Lat \textit{Gene Ontology (GO)}} i {\Lat \textit{Human Phenotype Ontology (HPO)}}. Kako se datoteke za anotacije redovno azhuriraju, cilj je i ugradjivanje opcije za preuzimanje istih.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\makebox[7cm][c]{\textbf{Andjela Mijailovic1, 1020/2017, MR}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% u donji red uneti:               ime i prezime mentora                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hspace{1.7cm} Saglasan mentor \makebox[7cm][c]{\textbf{dr Jovana Kovachevic1}} \\
